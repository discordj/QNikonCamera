...
enum eNkMAIDCapabilityD1
{
	...
	kNkMAIDCapability_InternalSplCommand		= kNkMAIDCapability_VendorBaseD1 + 0xc6,
	...
	kNkMAIDCapability_InternalSplCommandValue   = kNkMAIDCapability_VendorBaseD1 + 0xcb,
	kNkMAIDCapability_PreviewStatus				= kNkMAIDCapability_VendorBaseD1 + 0xcc,
	kNkMAIDCapability_PreviewImage				= kNkMAIDCapability_VendorBaseD1 + 0xcd,
	...
	kNkMAIDCapability_DeviceNameList			= kNkMAIDCapability_VendorBaseD1 + 0xda,
	kNkMAIDCapability_ImageColorSpace			= kNkMAIDCapability_VendorBaseD1 + 0xdb,
	kNkMAIDCapability_ISOAutoSetting			= kNkMAIDCapability_VendorBaseD1 + 0xdc,
	kNkMAIDCapability_ImageMode					= kNkMAIDCapability_VendorBaseD1 + 0xdd,
	...
	kNkMAIDCapability_RangeFinderStatus			= kNkMAIDCapability_VendorBaseD1 + 0x164,
...
enum eNkMAIDCameraType
{
	...
	kNkMAIDCameraType_D60 = 0x22,	// D60
...
// kNkMAIDCapability_DateCounterData(0x8261)
typedef struct tagNkMAIDDateCounterData
{
	wchar_t wcDate1[9];	// 1st date
	wchar_t wcDate2[9];	// 2nd date
	wchar_t wcDate3[9];	// 3rd date
...
typedef struct tagNkMAIDWBPresetData
{
	...
	ULONG  ulThumbnailRotate;	// Not used in D200 module.
